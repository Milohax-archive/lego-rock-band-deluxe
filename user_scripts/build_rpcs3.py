...
def validate_rpcs3_directory(rpcs3_directory):
    ...
    blus30382_folder_path = os.path.join(game_folder_path, "BLUS30382")
    ...
    if not os.path.exists(blus30382_folder_path):
        print("LEGO Rock Band (BLUS30382) not detected in the provided rpcs3 directory. Creating One.")
        os.makedirs(blus30382_folder_path, exist_ok=True)
        return True
...
if successful_extraction:
    if build_patch_ark(False, rpcs3_directory, rpcs3_mode=True):
        ...
        # Copy files from _build/ps3 to rpcs3_directory/game/BLUS30382
        ...
        destination_dir = os.path.join(rpcs3_directory, "game", "BLUS30382")
        ...
        eboot_bin_path = os.path.join(rpcs3_directory, "game", "BLUS30382", "USRDIR", "eboot.bin")
